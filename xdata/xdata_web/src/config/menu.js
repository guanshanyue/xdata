let menu = {
    menus: [
        ...
        {
            key: '4', desc: '应用发布', icon: 'fa fa-flag-o', permission: 'publish_app_view|publish_image_view', subs: [
            ...
            key: '5', desc: '配置管理', icon: 'fa fa-cogs', permission: 'config_environment_view|config_service_view|config_app_view', subs: [
            ...
            key: '6', desc: '任务管理', icon: 'fa fa-calendar', permission: 'job_task_view', subs: [
                {key: '/schedule/job', permission: 'job_task_view', desc: '任务列表'}
            ]
        }, {
            key: '7', desc: '监控管理', icon: 'fa fa-tachometer', subs: [
        ...
        {
            key: '8', desc: '告警管理', icon: 'fa fa-bell-o', subs: [
